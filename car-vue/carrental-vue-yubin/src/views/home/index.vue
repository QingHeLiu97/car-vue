                ...
                <el-card style="height:400px">
                    <div style="display:flex; align-items:center;">
                        ...
                        <div style="margin-left: 40px">
							...
							<p style="margin:0; color:#999" v-if="role == 'custom'">业主</p>
                     ...
                     <el-descriptions :column="1">
                        ...
                        <el-descriptions-item label="房号">{{userInfo?userInfo.residential:''}}</el-descriptions-item>
                    </el-descriptions>
                </el-card>
            </el-col>
            <el-col :span="12"  style="margin-bottom: 20px">
                <el-card style="height: 400px">
                    <div>社区公告<i class="el-icon-bell"></i></div>
                    <el-divider></el-divider>
...
<script>
    ...
    import { getMonthList } from '@api/complaint.js'
    export default {
        components: { columner },
        data () {
            return {
            ...
            getData () {
                ...
                getMonthList().then(res => {
                    ...
                    for (var item of listData) {
                        this.assessA[item.assessA - 1] += 1;
                        this.assessB[item.assessB - 1] += 1;
                        this.assessC[item.assessC - 1] += 1;
                    }
                    this.$refs.columnerA.init()
                    this.$refs.columnerB.init()
                    this.$refs.columnerC.init()
                }).catch(err => {})
            },
