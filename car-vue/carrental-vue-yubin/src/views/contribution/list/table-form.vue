          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="手机号" prop="userPhone">
                  <el-input v-model="formData.userPhone" size="small" clearable placeholder="请输入业主手机号"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="缴费方式" prop="type">
                  <el-select v-model="formData.type" size="small" clearable style="width:100%" placeholder="请选择缴费方式">
