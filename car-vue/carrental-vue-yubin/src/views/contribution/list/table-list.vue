<template>
  <el-card v-loading="loadingStatus" shadow="never">
    <el-table :data="tableData" border style="width: 100%" >
      ...
      <el-table-column header-align-="center" align="center" min-width="100" prop="userId" label="缴费人ID"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="100" prop="userName" label="姓名"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="100" prop="userPhone" label="手机号"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getData () {
                ...
                getContributionList({ pageSize, current, ...formData }).then(res => {
