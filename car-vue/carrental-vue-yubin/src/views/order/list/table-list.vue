<template>
  <el-card v-loading="loadingStatus" shadow="never">
    ...
    <el-table :data="tableData" border style="width: 100%" >
      <el-table-column header-align-="center" align="center" min-width="200" prop="order_id" label="编号"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="200" prop="car_id" label="汽车id"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="200" prop="car_type" label="汽车类型"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="200" prop="car_color" label="汽车颜色"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="150" prop="car_price" label="价格"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="200" prop="deposit" label="押金"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="200" prop="user_id" label="租车人id"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="200" prop="username" label="租车人姓名"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="200" prop="user_phone" label="客户电话"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="200" prop="user_address" label="客户地址"></el-table-column>
      <el-table-column header-align-="center" align="center" min-width="200" prop="handlers_name" label="经办人"></el-table-column>
